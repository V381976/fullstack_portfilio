...
export default function Hero() {
  const magneticRef1 = useMagnetic<HTMLButtonElement>(0.3)
  const magneticRef2 = useMagnetic<HTMLButtonElement>(0.3)
  const magneticRef3 = useMagnetic<HTMLButtonElement>(0.3)
      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <span className="inline-block px-4 py-2 rounded-full glass text-sm font-medium text-primary-foreground">
